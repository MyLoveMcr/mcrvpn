...
func (e *Mcrvpn) setFormData(data map[string]string) error {
...
func (e *Mcrvpn) getRunningUI() ui.Form {

	return ui.Form{
		Title:       "mcrvpn",
		Description: "Awesome Extension mcrvpn created by MyLoveMcr",
		Fields: [][]ui.FormField{
			{{
...
func (e *Mcrvpn) getStoppedUI() ui.Form {
	// Inital page
	return ui.Form{
		Title:       "mcrvpn",
		Description: "Awesome Extension mcrvpn created by MyLoveMcr",
...
func (e *Mcrvpn) addAndUpdateConsole(message ...any) {
